...
export default function Biography() {
   ...
   return (
      ...
      <section className="flex flex-col xs:items-center text-customLight bg-customDark py-8 ">
         ...
         <div className={`flex flex-col xs:items-center px-8 ${showBiography ? 'w-2/3' : ''}`}>

            <div className={`flex-col xs:flex-row xs:justify-center gap-8 pb-4 transition-all duration-1000 overflow-hidden ${showBiography ? 'opacity-100 max-h-[1000px]' : 'opacity-0  max-h-0'}`}
            >
            ...
            <div className={`xs:w-1/3 transition-all duration-1000 overflow-hidden ${showBiography ? 'opacity-0 max-h-0' : 'opacity-100 max-h-[1000px]'}`}>
